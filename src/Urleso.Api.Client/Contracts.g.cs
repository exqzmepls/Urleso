...
namespace Urleso.Api.Client
{
    ...
    public partial interface IApiClient
    {
        ...
        System.Threading.Tasks.Task<ShortenedUrlDetails> PostApiShortenedUrlsAsync(ShortenedUrlOptions options);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ShortenedUrlDetails> PostApiShortenedUrlsAsync(ShortenedUrlOptions options, System.Threading.CancellationToken cancellationToken);
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.0.2.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ShortenedUrlOptions
    {
